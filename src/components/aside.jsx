...
function Aside() {
  return (
    <aside className="p-10 w-[237px] bg-fondo-aside">
      <div className="mb-12 pb-12 font-bold text-challenges.io">
        <span className="text-dev">Dev</span>challenges.io
      </div>
      <div className="my-5 font-bold text-[14px] text-navegacion">Colors</div>
      <div className="my-5 font-bold text-[14px] text-navegacion">
        Typography
      </div>
